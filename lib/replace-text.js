...
var ReplaceText = function (opts) {
	...
	// regexes
	this.oldVersionFileNameRegex = new RegExp(this.regedFileNameBeg + '\\.[a-f0-9]{32}' + this.regedFileNameSuffix + '$', "ig");
	this.fileNameRegex = new RegExp(this.regedFileNameBeg + '(\\.[a-f0-9]{32}' + this.regedFileNameSuffix + ')|' + this.regedFileNameBeg + '(' + this.regedFileNameSuffix + ')', "ig");
	...
	this.fileNameRegexRequireJs = new RegExp(this.regedFileNameBeg + '\\.[a-f0-9]{32}(?!' + this.regedFileNameSuffix + ')(?!=)("|\')|' + this.regedFileNameBeg + '(?!' + this.regedFileNameSuffix + ')(?!=)("|\')', "ig");
